...
void BlueRingC(){
    ...
    chassis.turnToHeading(-92, 1000, {.direction=lemlib::AngularDirection::CCW_COUNTERCLOCKWISE, .maxSpeed = 70}); 
...
void RedMogo(){
    ...
    chassis.turnToHeading(-45.7, 700, {.direction=lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80}); 
